                ...
                c => new
                    {
                        ...
                        IsActivitied = c.Boolean(nullable: false),
                ...
                c => new
                    {
                        ...
                        DateCreared = c.DateTime(nullable: false),
                        DateUpdated = c.DateTime(nullable: false),
                        Status = c.Boolean(nullable: false),
                    })
                .PrimaryKey(t => t.ID)
                ...
                c => new
                    {
                        ...
                        RoleID = c.Guid(),
                        ModuleID = c.Guid(),
                        AuView = c.Boolean(nullable: false),
                        AuInsert = c.Boolean(nullable: false),
                        AuUpdate = c.Boolean(nullable: false),
                        AuDelete = c.Boolean(nullable: false),
                        DateCreated = c.DateTime(nullable: false),
                        DateUpdated = c.DateTime(nullable: false),
                        Status = c.Boolean(nullable: false),
                    })
                ...
                c => new
                    {
                        ...
                        IsFeaturedPost = c.Boolean(nullable: false),
                    })
                .PrimaryKey(t => t.ID)
                .ForeignKey("dbo.Accounts", t => t.AccountID)
                .Index(t => t.AccountID);
                ...
                c => new
                    {
                        ...
                        Code = c.String(),
                        Value = c.String(),
                        AutoLoad = c.Boolean(nullable: false),
                        DateCreated = c.DateTime(nullable: false),
                        DateUpdated = c.DateTime(nullable: false),
                        Status = c.Boolean(nullable: false),
                    })
