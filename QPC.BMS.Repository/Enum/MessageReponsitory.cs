...
namespace QPC.BMS.Repository.Enum
{
    public static class MessageReponsitory
    {
        ...
        public const string DELETE_ACCOUNT_SUCCESSFUL = "Delete acocunt is successfully!";

        public const string DELETE_ACCOUNT_UNSUCCESSFUL = "Delete account is unsuccessfuly!";

        public const string ACCOUNT_NOT_EXISTS = "Account doesn't exist!";

        public const string NOTT_RESULT = "No Search Result!";
