...
namespace QPC.BMS.Repository
{
    ...
    public interface ICommonRepository
    {
        ...
        IEnumerable<Faculties> GetFacultiesByExpression(Func<Faculties, bool> expression);
        ...
        Faculties GetFacultyByID(Guid facultyID);
        ...
        /// <returns>true or false</returns>
        Boolean SetFaculty(Faculties model);
        ...
        /// <param name="models">list object</param>
        /// <returns>true or false</returns>
        Boolean SetListFaculties(List<Faculties> models);
        ...
        /// <param name="expression">lamdar expression</param>
        /// <returns>true or false</returns>
        Boolean EditFacultyByExpression(Func<Faculties, bool> expression);
        ...
        /// <param name="modelEdit">object edit</param>
        /// <returns>true or false</returns>
        Boolean EditFacultyByObject(Faculties modelEdit);
        ...
        /// <param name="expression">lamdar expression</param>
        /// <returns>true or false</returns>
        Boolean DeleteFacultyByExpression(Func<Faculties, bool> expression);
