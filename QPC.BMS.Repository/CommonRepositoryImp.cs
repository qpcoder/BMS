...
namespace QPC.BMS.Repository
{
    ...
    class CommonRepositoryImp : ICommonRepository
    {
        ...
        public bool DeleteFacultyByExpression(Func<Faculties, bool> expression)
        {
            throw new NotImplementedException();
        }
        ...
        public bool EditFacultyByExpression(Func<Faculties, bool> expression)
        {
            throw new NotImplementedException();
        }

        public bool EditFacultyByObject(Faculties modelEdit)
        {
            throw new NotImplementedException();
        }
        ...
        public IEnumerable<Faculties> GetFacultiesByExpression(Func<Faculties, bool> expression)
        {
            throw new NotImplementedException();
        }

        public Faculties GetFacultyByID(Guid facultyID)
        {
            throw new NotImplementedException();
        }
        ...
        public bool SetFaculty(Faculties model)
        {
            throw new NotImplementedException();
        }
        ...
        public bool SetListFaculties(List<Faculties> models)
        {
            throw new NotImplementedException();
        }
